                    ...
                    <div class="mb-6">
                        <form id="filterForm" class="grid grid-cols-1 sm:grid-cols-4 gap-3">
                            ...
                            <div>
                                ...
                                <select id="typeFilter" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <script>
        ...
        async function loadReferenceData(forceRefresh = false) {
            try {
                ...
                const url = `${API_BASE_URL}?endpoint=absence&nik=${USER_NIK}&tahun=${new Date().getFullYear()}${timestamp}`;
        ...
        $('#btnSubmitAbsence').click(async function() {
            ...
            try {
                ...
                if (tipe === '1200' || tipe === '1300') {
                    ...
                    formData.append('buktiupload', file);
                ...
                if (result.success) {
                    ...
                    if (fileUrl) {
                        successMessage += ' File tersimpan di storage.';
                    }
