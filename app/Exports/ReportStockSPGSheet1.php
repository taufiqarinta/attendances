...
class ReportStockSPGSheet1 implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths, WithTitle // <-- Tambahkan WithTitle di sini
{
    protected $filters;
    ...
    // <-- Tambahkan method title() ini
    public function title(): string
    {
        return 'Laporan Stock Peritem';
    }
